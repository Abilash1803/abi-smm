...
const ProfileOverview = () => {
  ...
  const profileData = {
    ...
    bio: 'Content creator | Digital marketer | Lifestyle enthusiast',
    verified: true,
    isPrivate: false
  }
  ...
  const platformServices = {
    instagram: [
      { id: 'followers', name: 'Followers', icon: '👥', description: 'Get real Instagram followers', price: 'From $2.99', popular: true },
      { id: 'likes', name: 'Likes', icon: '❤️', description: 'Boost your post likes', price: 'From $1.99', popular: false },
      { id: 'comments', name: 'Comments', icon: '💬', description: 'Get authentic comments', price: 'From $4.99', popular: false },
      { id: 'views', name: 'Views', icon: '👁️', description: 'Increase story/reel views', price: 'From $0.99', popular: false },
      { id: 'saves', name: 'Saves', icon: '🔖', description: 'Get post saves', price: 'From $3.99', popular: false },
      { id: 'shares', name: 'Shares', icon: '📤', description: 'Increase post shares', price: 'From $2.49', popular: false }
    ],
    youtube: [
      { id: 'subscribers', name: 'Subscribers', icon: '👥', description: 'Gain real subscribers', price: 'From $4.99', popular: true },
      { id: 'views', name: 'Views', icon: '👁️', description: 'Boost video views', price: 'From $1.99', popular: false },
      { id: 'likes', name: 'Likes', icon: '👍', description: 'Get video likes', price: 'From $2.99', popular: false },
      { id: 'comments', name: 'Comments', icon: '💬', description: 'Authentic comments', price: 'From $5.99', popular: false },
      { id: 'shares', name: 'Shares', icon: '📤', description: 'Increase video shares', price: 'From $3.49', popular: false },
      { id: 'watchtime', name: 'Watch Time', icon: '⏱️', description: 'Boost watch hours', price: 'From $7.99', popular: false }
    ],
    facebook: [
      { id: 'page_likes', name: 'Page Likes', icon: '👍', description: 'Get page followers', price: 'From $3.99', popular: true },
      { id: 'post_likes', name: 'Post Likes', icon: '❤️', description: 'Boost post engagement', price: 'From $1.99', popular: false },
      ...
      { id: 'video_views', name: 'Video Views', icon: '📹', description: 'Boost video views', price: 'From $1.49', popular: false },
      { id: 'followers', name: 'Followers', icon: '👥', description: 'Personal profile followers', price: 'From $3.49', popular: false }
    ],
    tiktok: [
      { id: 'followers', name: 'Followers', icon: '👥', description: 'Get TikTok followers', price: 'From $3.99', popular: true },
      { id: 'likes', name: 'Likes', icon: '❤️', description: 'Boost video likes', price: 'From $1.99', popular: false },
      { id: 'views', name: 'Views', icon: '👁️', description: 'Increase video views', price: 'From $0.99', popular: false },
      { id: 'comments', name: 'Comments', icon: '💬', description: 'Get video comments', price: 'From $4.99', popular: false },
      { id: 'shares', name: 'Shares', icon: '📤', description: 'Boost video shares', price: 'From $2.99', popular: false },
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-8">
                <div className="text-center">
                  <div className="text-xl font-bold text-gray-900">{profileData.postsCount}</div>
                ...
                <div className="bg-white border-2 border-gray-100 rounded-2xl p-6 hover:border-gray-200 transition-all group-hover:shadow-lg">
                  <div className="text-center mb-4">
                    <div className={`w-16 h-16 bg-gradient-to-r ${config.color} rounded-2xl flex items-center justify-center text-white mx-auto mb-3 shadow-lg`}>
                      ...
                      {service.id === 'subscribers' && (
                        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                          <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3z"/>
                        </svg>
                      )}
                      {service.id === 'watchtime' && (
                        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd"/>
                        </svg>
                      )}
                      {service.id === 'page_likes' && (
                        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
