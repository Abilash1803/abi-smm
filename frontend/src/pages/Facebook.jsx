      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Buy Facebook Services for Faster Popularity
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Grow your Facebook page with our premium services. Search for your page to get started.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-600 mb-4">
            Enter your Facebook page name to view your profile and select posts to boost
          </p>
