  ...
  return (
    <div className="py-20 px-6 bg-gradient-to-br from-purple-100/30 via-white/50 to-purple-50/20">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div 
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12 mb-12"
        ...
        <motion.div 
          className="text-center bg-gradient-to-r from-[#FF6B35]/10 to-[#FFA500]/10 backdrop-blur-xl rounded-3xl border border-white/60 p-8 shadow-lg"
