    ...
    <div className="py-12 px-4 bg-gradient-to-br from-purple-50/20 via-white/40 to-purple-100/30">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4">
            ...
            <div className="group cursor-pointer">
              <div className={`${features[0].bgColor} rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.02] relative overflow-hidden h-64 md:h-72 lg:h-56`}>
                {/* Category Label */}
            ...
            <div className="group cursor-pointer">
              <div className={`${features[1].bgColor} rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.02] relative overflow-hidden h-64 md:h-72 lg:h-56`}>
                {/* Category Label */}
                <div className="absolute top-4 left-4">
            ...
            <div className="group cursor-pointer">
              <div className={`${features[2].bgColor} rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.02] relative overflow-hidden h-64 md:h-72 lg:h-56`}>
                {/* Category Label */}
                <div className="absolute top-4 left-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
            ...
            <div className="group cursor-pointer">
              <div className={`${features[3].bgColor} rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.02] relative overflow-hidden h-56 md:h-64 lg:h-56`}>
                {/* Category Label */}
                <div className="absolute top-4 left-4">
            ...
            <div className="group cursor-pointer">
              <div className={`${features[4].bgColor} rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.02] relative overflow-hidden h-56 md:h-64 lg:h-56`}>
                {/* Category Label */}
                <div className="absolute top-4 left-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4">
            ...
            <div className="group cursor-pointer">
              <div className={`${features[5].bgColor} rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.02] relative overflow-hidden h-64 md:h-72 lg:h-56`}>
                {/* Category Label */}
                <div className="absolute top-4 left-4">
            ...
            <div className="group cursor-pointer">
              <div className={`${features[6].bgColor} rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.02] relative overflow-hidden h-64 md:h-72 lg:h-56`}>
                {/* Category Label */}
                <div className="absolute top-4 left-4">
            ...
            <div className="group cursor-pointer">
              <div className={`${features[7].bgColor} rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.02] relative overflow-hidden h-64 md:h-72 lg:h-56`}>
                {/* Category Label */}
                <div className="absolute top-4 left-4">
        ...
        <div className="text-center mt-10" >
          <button onClick={() => navigate('/register')} className="px-6 py-3 bg-gradient-to-r from-[#FF6B35] to-[#FFA500] text-white rounded-full font-semibold text-base hover:shadow-lg hover:shadow-[#FF6B35]/40 transition-all hover:scale-105">
            Get Started Today
          </button>
        </div>
