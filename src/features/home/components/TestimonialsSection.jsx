...
export default function Testimonials() {
  ...
  const TestimonialCard = ({ testimonial }) => (
    <motion.div 
      ...
      className="flex-shrink-0 w-80 mx-4 backdrop-blur-xl rounded-2xl border-2 border-white/60 p-6 shadow-2xl hover:shadow-3xl transition-all duration-500 group relative overflow-hidden bg-white/10 hover:bg-white/20"
    >
