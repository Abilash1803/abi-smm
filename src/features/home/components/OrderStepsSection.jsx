  ...
  return (
    <div className="py-20 px-6 bg-gradient-to-br from-purple-50/25 via-white/45 to-purple-100/25">
      <div className="max-w-6xl mx-auto">
              ...
              >
                <div className="w-1/2 pr-16">
                  {index % 2 === 0 ? (
                    <motion.div 
                      ...
                      className={`bg-gradient-to-r ${step.gradient} rounded-full px-8 py-4 inline-flex items-center gap-4 shadow-2xl transition-all duration-300 ml-auto`}
                    >
                ...
                <div className="w-1/2 pl-16">
                  {index % 2 === 1 ? (
                    <motion.div 
                      whileHover={{ scale: 1.05 }}
                      className={`bg-gradient-to-r ${step.gradient} rounded-full px-8 py-4 inline-flex items-center gap-4 shadow-2xl transition-all duration-300`}
                    >
                      <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg">
                        <span className="text-2xl">{step.icon}</span>
                      </div>
        ...
        <motion.div 
          className="text-center mt-12 sm:mt-20 bg-white/40 backdrop-blur-xl rounded-2xl border border-white/60 p-6 sm:p-8 shadow-lg max-w-4xl mx-auto"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
