      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="relative h-96 mb-20">
          ...
          <div className="relative w-full max-w-5xl mx-auto flex items-center justify-center h-full">
            {/* Left Card */}
            <div 
              className="absolute left-4 sm:left-8 lg:left-4 top-1/2 -translate-y-1/2 rotate-[-15deg] transition-all duration-300"
            ...
            <div 
              className="absolute left-24 sm:left-32 lg:left-36 top-1/2 -translate-y-1/2 rotate-[-8deg] transition-all duration-300 hidden sm:block"
            ...
            <div 
              className="absolute right-24 sm:right-32 lg:right-36 top-1/2 -translate-y-1/2 rotate-[8deg] transition-all duration-300 hidden sm:block"
            ...
            {/* Right Card */}
            <div 
              className="absolute right-4 sm:right-8 lg:right-4 top-1/2 -translate-y-1/2 rotate-[15deg] transition-all duration-300"
